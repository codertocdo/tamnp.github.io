...
We cannot simply remove a <span class = "txt-error">key from</span> an internal node without breaking the structural routing mechanism of the tree. Instead, we must replace it:
